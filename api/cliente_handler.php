...
class ClienteHandler
{
    ...
    */
    ...
    public function editProfile($idClientee)
    {
        $sql = 'UPDATE cliente
                SET nombre_cliente = ?, apellido_cliente = ?, direccion_cliente = ?
                WHERE id_cliente = ?';
        $params = array($this->nombre, $this->apellido, $this->direccion, $idClientee);
        return Database::executeRow($sql, $params);
    }
